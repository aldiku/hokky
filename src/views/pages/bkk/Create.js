...
export default function CreatebKK() {
  ...
  function CreateData() {
    ...
    axios
      .post(`${process.env.REACT_APP_API_BASE_URL}/bkk/save`, data, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
  ...
  return (
    <>
      <SimpleHeader name="Daftar Bukti Kas Keluar" parentName="Admin" />
