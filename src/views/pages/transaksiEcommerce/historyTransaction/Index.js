...
const TransaksiHistory = () => {
  ...
  const redirectPrefix = `/admin/so-penawaran/edit/`;
  const redirectPrefix1 = `/admin/so-penawaran/detail/`;
  ...
  const getPenawaranSo = (page, perPage, currentSort) => {
    ...
    axios
      .post(`${process.env.REACT_APP_API_BASE_URL}/transaction/erp/history`, data, {
        headers,
      })
      .then((data) => {
