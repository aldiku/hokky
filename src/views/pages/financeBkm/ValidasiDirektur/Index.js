...
const ValidasiDirekturBkmFinance = () => {
  const token = localStorage.token;
  const warehouse = parseInt(localStorage.warehouse);
  const redirectPrefix = `/admin/bkm-finance/edit/`;
  const redirectPrefix1 = `/admin/bkm-finance/validasi-direktur/`;
              ...
              <CardHeader className="bg-white border-0">
                <div style={{ display: "flex", justifyContent: "space-between" }}>
                  ...
                  {/* <div style={{ textAlign: 'right' }}>
                    <Link className="btn btn-info" to="/admin/bkm-finance/create">
...
export default ValidasiDirekturBkmFinance;
