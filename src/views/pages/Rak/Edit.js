...
export default function EditRak(props) {
  ...
  const EditRak = () => {
    ...
    axios.post(`${process.env.REACT_APP_API_BASE_URL}/rak/update/${props.match.params.id}`, data, {
        headers: {
          Authorization: `Bearer ${token}`,
        }
      })
  ...
  return (
    <div>
      <SimpleHeader name="Edit Rak" parentName="Master" />
