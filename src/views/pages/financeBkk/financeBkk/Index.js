...
const BuktiKasKeluarFinance = () => {
  const token = localStorage.token;
  const warehouse = parseInt(localStorage.warehouse);
  const redirectPrefix = `/admin/bukti-kas-keluar/edit/`;
  const redirectPrefix1 = `/admin/bukti-kas-keluar/detail/`;
...
export default BuktiKasKeluarFinance;
