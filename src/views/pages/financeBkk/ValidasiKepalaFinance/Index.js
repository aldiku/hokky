...
const ValidasiKepalaTokoBKK = () => {
  const token = localStorage.token;
  const warehouse = parseInt(localStorage.warehouse);
  const redirectPrefix = `/admin/bkk-finance/validasi-kepala-toko/`;
  const redirectPrefix1 = `/admin/bkk-finance/validasi-kepala-toko/`;
              ...
              <CardHeader className="bg-white border-0">
                <div style={{ display: "flex", justifyContent: "space-between" }}>
                  ...
                  <div style={{ textAlign: 'right' }}>
                    <Link className="btn btn-info" to="/admin/bkk-finance/create">
...
export default ValidasiKepalaTokoBKK;
