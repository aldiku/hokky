...
export default function Userss() {
  ...
  const getById = (id) => {
    ...
    axios
      .get(`${process.env.REACT_APP_API_BASE_URL}/karyawan/get/${itemId}`, {
        headers,
      })
      .then((data) => {
  ...
  const getUser = async () => {
    ...
    const res = await axios.post(
      `${process.env.REACT_APP_API_BASE_URL}/karyawan/page`,
      data,
      { headers }
    );
  ...
  const cekKasir = async () => {
    const res = await axios.post(
      `${process.env.REACT_APP_API_BASE_URL}/karyawan/create-access/`,
      { karyawan_id: itemId },
      { headers }
    );
    if (res.data.status === 200) {
  ...
  function UpdateKaryawan() {
    ...
    axios
      .post(
        `${process.env.REACT_APP_API_BASE_URL}/karyawan/update/${itemId}`,
        data,
        {
          headers,
        }
              ...
              <Card className="bg-secondary shadow">
                ...
                <Row md="12">
                  ...
                  <Col md="6">
                    <CardBody>
                      <FormGroup row>
                        <Label for="exampleEmail" sm={4}></Label>
                        <CardGroup>
                          <Row>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
