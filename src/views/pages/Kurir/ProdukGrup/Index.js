...
const ProdukGrup = () => {
  ...
  const redirectPrefix = `/admin/kurir/produk-kurir/edit/`;
  ...
  const getKurir = (page, perPage, currentSort) => {
    ...
    axios
      .post(`${process.env.REACT_APP_API_BASE_URL}/item-group/page`, data, {
        headers,
      })
      .then((data) => {
              ...
              <CardHeader>
                <div style={{ display: "flex", justifyContent: "space-between" }}>
                  ...
                  <div style={{ textAlign: 'right' }}>
                    <Link className="btn btn-info" to="/admin/list-kurir/produk-grup/create">
                      Buat Produk Grup
                    </Link>
                  </div>
                </div>
