...
const KurirbyWarehouse = () => {
  const token = localStorage.token;
  const warehouse = parseInt(localStorage.warehouse);
  const redirectPrefix = `/admin/list-kurir/kurir-by-warehouse/edit/`;
  ...
  const getKurir = (page, perPage, currentSort) => {
    ...
    axios
      .post(`${process.env.REACT_APP_API_BASE_URL}/courier/page`, data, {
        headers,
      })
      .then((data) => {
            ...
            <Card>
              <CardHeader>
                <div style={{ display: "flex", justifyContent: "space-between" }}>
                  <h3>Kurir By Warehouse</h3>
                  <div style={{ textAlign: 'right' }}>
                    <Link className="btn btn-info" to="/admin/list-kurir/kurir-by-warehouse/create">
                      Buat List Kurir
                    </Link>
                  </div>
                </div>
...
export default KurirbyWarehouse;