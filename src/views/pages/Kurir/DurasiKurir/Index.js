...
const DurasiKurir = () => {
  ...
  const getKurir = (page, perPage, currentSort) => {
    ...
    axios
      .post(`${process.env.REACT_APP_API_BASE_URL}/courier-type/page`, data, {
        headers,
      })
      .then((data) => {
              ...
              <CardHeader>
                <div style={{ display: "flex", justifyContent: "space-between" }}>
                  ...
                  <div style={{ textAlign: 'right' }}>
                    <Link className="btn btn-info" to="/admin/list-kurir/durasi-kurir/create">
                      Buat Durasi Kurir
                    </Link>
                  </div>
                </div>
