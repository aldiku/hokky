...
const ValidasiKepalaToko = () => {
  const token = localStorage.token;
  const warehouse = parseInt(localStorage.warehouse);
  const redirectPrefix = `/admin/transfer-warehouse-stock/validasi-kepala-toko/validasi/`;
...
export default ValidasiKepalaToko;