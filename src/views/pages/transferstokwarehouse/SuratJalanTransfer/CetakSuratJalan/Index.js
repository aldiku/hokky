...
const CetakSuratJalan = () => {
  ...
  const redirectPrefix = `/cetak/transfer-surat-jalan/cetak/`;
  const [rowIndex, setRowIndex] = useState(0);
  const [allSuratJalanTransfer, setAllSuratJalanTransfer] = useState([]);
  ...
  const getSuratJalanTransfer = (page, perPage, currentSort) => {
    ...
    axios
      ...
      .then((data) => {
        setAllSuratJalanTransfer(data.data.response);
