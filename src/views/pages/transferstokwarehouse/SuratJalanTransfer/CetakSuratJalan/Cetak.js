...
export default function CetakSuratJalanTransfer(props) {
  ...
  const getById = () => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_API_BASE_URL}/transfer-surat-jalan/cetak/${props.match.params.id}`,
        { headers }
      )
      .then((data) => {
        setTw(data.data.response.tsj.tr_code);
        setCode(data.data.response.tsj.kode_cabang_pengirim);
        setCabang(data.data.response.tsj.nama_cabang_pengirim);
        setWaktu(data.data.response.tsj.created)
        setWarehouse(data.data.response.tsj.warehouse);
        setKeterangan(data.data.response.tsj.keterangan);
        setManajer(data.data.response.tsj.validator);
        setDirektur(data.data.response.tsj.direktur);
            ...
            <Card>
                <CardBody>
                    ...
                    <CardHeader>
                        <Row md="12">
                            <Col md="12">
                                <h3><b><center>SURAT JALAN TRANSFER STOK</center></b></h3>
                            </Col>
                        </Row>
                    </CardHeader>
                    <Table>
                            ...
                            <tr>
                                ...
                                <Row md="24">
                                        ...
                                        <div className="row align-items-center mb-3">
                                            <div className="col-4">Kode Surat Jalan</div>
