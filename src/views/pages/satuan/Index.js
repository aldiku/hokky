...
import { Card, Button, Row, Col, CardBody, CardHeader, Container, UncontrolledTooltip, ButtonGroup, Collapse, Form, FormGroup, Label, Input, Modal, ModalHeader, ModalBody } from 'reactstrap';
  ...
  return (
    <div>
      ...
      <Modal isOpen={modal} toggle={toggle}>
                        ...
                        {!isLoading && (
                            <Button color="primary" onClick={() => updateSatuan()}>
                            Lanjutkan
                            </Button>
                        )}
                        {isLoading && (
