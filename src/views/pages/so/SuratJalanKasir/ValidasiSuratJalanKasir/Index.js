...
const ValidasiSuratJalanSo = () => {
  const token = localStorage.token;
  const warehouse = parseInt(localStorage.warehouse);
  const redirectPrefix = `/admin/validasi-surat-jalan-kasir/edit/`;
  const redirectPrefix1 = `/admin/cetak-so/`;
...
export default ValidasiSuratJalanSo;