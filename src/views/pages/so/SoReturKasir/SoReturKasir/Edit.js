...
const EditSoReturKasirBaru = (props ) => {
  ...
  const getById = () => {
    ...
    axios
      ...
      .then((data) => {
        ...
        setCodeInvoice(data.data.response.code_transaction);
          ...
          <Card className="bg-secondary shadow">
              ...
              <Card className="bg-secondary shadow">
                ...
                <CardFooter>
                      ...
                      <Link className="btn btn-info" to="/admin/kasir-retur">
                        Kembali
                      </Link>
                </CardFooter>
...
export default EditSoReturKasirBaru;
