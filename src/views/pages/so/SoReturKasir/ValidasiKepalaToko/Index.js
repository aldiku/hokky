...
const ValidasiKepalaTokoReturKasir = () => {
  const token = localStorage.token;
  const warehouse = parseInt(localStorage.warehouse);
  const redirectPrefix = `/admin/kasir-retur/validasi-kepala-toko/`;
          ...
          <Card className="bg-secondary shadow">
              <CardHeader className="bg-white border-0">
                <div style={{ display: "flex", justifyContent: "space-between" }}>
                  ...
                  {/* <div style={{ textAlign: 'right' }}>
                    <Link className="btn btn-info" to="/admin/kasir-retur/create">
              ...
              <CardBody>
                    ...
                    <ToolkitProvider
                            ...
                            {
                                dataField: "status_ar1",
                                text: "Status",
                                sort: true,
                                formatter: (cell, row) => {
                                  return row.status_ar1 === 3
                                    ? 'proses'
                                    : row.status_ar1 === 4
                                    ? 'Tidak Setuju'
                                    : 'Setuju';
...
export default ValidasiKepalaTokoReturKasir;