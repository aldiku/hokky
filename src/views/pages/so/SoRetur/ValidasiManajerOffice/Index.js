...
const SoReturValidasiManajerOffice = () => {
  const token = localStorage.token;
  const warehouse = parseInt(localStorage.warehouse);
  const redirectPrefix = `/admin/so-retur/validasi-manager-office/`;
  const redirectPrefix1 = `/admin/so-retur/validasi-manager-office/detail/`;
...
export default SoReturValidasiManajerOffice;