...
import SoReturKasir from "./SoReturKasir/Index.js";
import SoReturProyek from "./SoReturProyek/Index.js";
...
export default function SoRetur() {
  ...
  return (
    <>
      <SimpleHeader name="So Retur" parentName="SO" />
