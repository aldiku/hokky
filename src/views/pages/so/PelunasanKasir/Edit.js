				...
				<ModalBody
					...
					<div className="container">
						...
						<div className="row align-items-center mb-3">
							...
							<div className="col-1 text-center">:</div>
							<div className="col-4 text-center">
								<Input disabled={pay3 < 0} className="form-control-alternative" type="number" value={pay2} onChange={(event) => setPay2(event.target.value)} placeholder="Masukan Nomminal Pembayaran"></Input>
							</div> 
							<div className="col-4 text-center">
									<Input className="form-control-alternative"
									disabled={pay2 > 1000}
                        ...
                        <div className="row align-items-center mb-3">
							...
							<div className="col-1 text-center">:</div>
							<div className="col-4 text-center">
								<Input disabled={pay4 > -1} className="form-control-alternative" type="number" value={pay3} onChange={(event) => setPay3(event.target.value)} placeholder="Masukan Nomminal Pembayaran"></Input>
							</div>
							<div className="col-4 text-center">
								<Input className="form-control-alternative"
									name="Tipe Po"
                        ...
                        <div className="row align-items-center mb-3">
							...
							<div className="col-1 text-center">:</div>
							<div className="col-4 text-center">
								<Input disabled={pay4 > 1000} className="form-control-alternative" type="number" value={pay4} onChange={(event) => setPay4(event.target.value)} placeholder="Masukan Nomminal Pembayaran"></Input>
							</div>
							<div className="col-4 text-center">
								<Input className="form-control-alternative"
									name="Tipe Po"
                        ...
                        <div className="row align-items-center mb-3">
							...
							<div className="col-1 text-center">:</div>
							<div className="col-4 text-center">
								<Input  disabled={pay5 > 1000} className="form-control-alternative" type="number" value={pay5} onChange={(event) => setPay5(event.target.value)} placeholder="Masukan Nomminal Pembayaran"></Input>
							</div>
							<div className="col-4 text-center">
								<Input className="form-control-alternative"
									name="Tipe Po"
                        ...
                        <div className="row align-items-center mb-3">
							...
							<div className="col-1 text-center">:</div>
							<div className="col-4 text-center">
								<Input disabled={pay6 > 1000} className="form-control-alternative" type="number" value={pay6} onChange={(event) => setPay6(event.target.value)} placeholder="Masukan Nomminal Pembayaran"></Input>
							</div>
							<div className="col-4 text-center">
								<Input className="form-control-alternative"
									name="Tipe Po"
