...
const UsersEcommerce = (props) => {
  const token = localStorage.token;
  const warehouse = localStorage.warehouse;
  const [activeTab, setActiveTab] = useState('1');
  const [allUser, setAllUser] = useState([]);
  const redirectPrefix = `/admin/ecommerce-users/detail/`;
  ...
  return (
    <div>
      {alert}
      <SimpleHeader name="Users" parentName="E-Commerce" />
                      ...
                      <Col md="12">
                        <Card>
                          <CardHeader>
                            ...
                            >
                              <h3>List Users E-commerce</h3>
                              <div style={{ textAlign: 'right' }}>
                                <Link
                                  className="btn btn-info"
                                  to="/admin/ecommerce-users/create"
                                >
                                  Add
                                </Link>
                              </div>
