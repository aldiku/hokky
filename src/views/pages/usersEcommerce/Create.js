...
export default function CreateUsersEcommerce() {
  const token = localStorage.token;
  const warehouse = localStorage.warehouse;
  const roleId = localStorage.role;
  ...
  function CreateData() {
    ...
    axios
      ...
      .then(function (response) {
        history.push("/admin/ecommerce-users");
      })
      .then((json) => {
        setLoading(false);
      })
  ...
  return (
    <>
      <SimpleHeader name="Create User E-Commerce" parentName="Master" />
              ...
              <CardBody>
                <Form onSubmit={handleSubmit}>
                  ...
                  <CardFooter>
                    ...
                    <Link className="btn btn-info" to="/admin/user-ecommerce">
                    Kembali
                    </Link>
                  </CardFooter>
                </Form>
