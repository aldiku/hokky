...
import { Card, Button, Row, Col, CardBody, CardHeader, CardFooter, Table,InputGroup, InputGroupAddon, Container, Form, FormGroup, Label, Input, Modal, ModalHeader, ModalBody} from "reactstrap";
...
const saveItem1 = () => {
    ...
    axios.post(`${process.env.REACT_APP_API_BASE_URL}/invoice-po/page`, {
        ...
        if (length === 0)
            return;
            const idItem = res.data.response[0].invoice_code;
            axios.get(`${process.env.REACT_APP_API_BASE_URL}/invoice-po/get-by-code/${idItem}`)
            .then(async response => {
                return {
                ...
                setCodeInvoice(data.item.invoice_code);
...
const formatRupiah = (money) => {
  ...
  return (
    <>
    <SimpleHeader name="Buat Retur PO" parentName="PO" />
                      ...
                      <Row md="12">
                          ...
                          <FormGroup row>
                              ...
                              <InputGroupAddon addonType="append">
                                <Button color="default" outline onClick={() => saveItem1()}><i class="fa fa-search" aria-hidden="true"></i></Button>
                              </InputGroupAddon>
                              <AutoCompleTes1 />
                              </InputGroup>
                              </Col>                             
