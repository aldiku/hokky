...
const PoReturPo = () => {
  ...
  const redirectPrefix = `/admin/po-retur/edit/`;
  const redirectPrefix1 = `/admin/po-retur/detail/`;
              ...
              <CardHeader className="bg-white border-0">
                <div style={{ display: "flex", justifyContent: "space-between" }}>
                  ...
                  <div style={{ textAlign: 'right' }}>
                    <Link className="btn btn-info" to="/admin/po-retur/create">
