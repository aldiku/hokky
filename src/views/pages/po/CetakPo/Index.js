...
import { Card, Button, Row, Col, CardBody, CardHeader, ButtonGroup, Form, FormGroup, Label, Input,DropdownItem,DropdownMenu, UncontrolledDropdown, DropdownToggle, } from 'reactstrap';
...
const ValidatorPo = () => {
  ...
  const redirectPrefix = `/cetak/purchase-order/cetak/`;
  const redirectPrefix2 = `/cetak/memo-kurir-po/cetak/`;
  const redirectPrefix1 = `/admin/purchase-order/detail-po/`;
                                  ...
                                  <UncontrolledDropdown nav>
                                      ...
                                      <DropdownMenu>
                                            ...
                                            <Link to={redirectPrefix2 + row.id}
                                              ...
                                              target="_blank">
                                            <DropdownItem>
                                              <i className="fas fa-book" /><span>Cetak Memo</span>
                                            </DropdownItem>
                                            </Link>
                                            )}
                                            <Link to={redirectPrefix1 + row.id}
