...
const ValidasiPermintaanBarang = () => {
  ...
  const redirectPrefix = `/admin/validasi-permintaan-barang/edit/`;
  ...
  const allInfo = JSON.parse(localStorage.allinfo);
	const updateButton = String(allInfo.privileges.filter((i) => i.privilege_name === "Tab Validasi Rfq PO").map((p) => p.update_access));
