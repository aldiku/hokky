...
import ModalCetakInvoicePo from "./ModalCetakInvoicePo";

const InvoicePO = () => {
  const token = localStorage.token;
  const warehouse = parseInt(localStorage.warehouse);
  const redirectPrefix = `/cetak/invoice-po/cetak/`;
  const redirectPrefix1 = `/admin/invoice-po/detail-invoice/`;
