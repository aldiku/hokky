...
const Penjualan = () => {
  ...
  const redirectPrefix = `/admin/transfer/penjualan/edit/`;
  const redirectPrefix1 = `/admin/transfer/penjualan/detail/`;
              ...
              <CardBody>
                      <Form>
                        <Row md="12">
                          <Col md="3">
                            <FormGroup>
                              <Label htmlFor="exampleFormControlSelect3">Kode Penjualan</Label>
                              <Input
                                type="text"
