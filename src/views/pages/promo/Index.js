...
export default function Promo() {
  ...
  const getById = () => {
    ...
    axios
      .get(`${process.env.REACT_APP_API_BASE_URL}/promo/get/${itemId}`, {
        headers,
      })
      .then((data) => {
  ...
  const getUser = async () => {
    ...
    const res = await axios.post(
      `${process.env.REACT_APP_API_BASE_URL}/promo/page`,
      data,
      { headers }
    );
  ...
  function UpdatePromo() {
    ...
    axios
      .post(
        `${process.env.REACT_APP_API_BASE_URL}/promo/update/${itemId}`,
        data,
        {
          headers,
        }
