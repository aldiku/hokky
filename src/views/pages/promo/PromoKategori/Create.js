...
export default function CreatePromo() {
  ...
  function CreateData() {
    ...
    axios
        .post(
          `${process.env.REACT_APP_API_BASE_URL}/promo/single-promo-per-kategori/save`,
          data,
          {
            headers: {
...
const changePriceStatus = (index, status) => {
  ...
  return (
    <>
      <SimpleHeader name="Daftar Promo Kategori" parentName="Master" />
                                        ...
                                        {editingItem[key].editing ? (
                                            <>
                                                ...
                                                <>
                                                    ...
                                                    <Button color="danger" onClick={() => deleteItem1(savedItem.item_id)}>Delete</Button>
                                                </>
                                            )}
                                    </td>
                                </tr>
