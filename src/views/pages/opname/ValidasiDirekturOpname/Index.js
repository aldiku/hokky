...
const ValidasiDirekturOpname = () => {
  const token = localStorage.token;
  const warehouse = parseInt(localStorage.warehouse);
  const redirectPrefix = `/admin/stock-opname/validasi-direktur/`;
  ...
  const getOpname = (page, perPage, currentSort) => {
...
export default ValidasiDirekturOpname;