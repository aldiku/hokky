...
export default function Userss() {
  ...
  const getById = (id) => {
    ...
    axios
      .get(`${process.env.REACT_APP_API_BASE_URL}/users/get/${id}`, { headers })
      .then((data) => {
  ...
  const getItemDataSaved = () => {
    ...
    axios
      .post(
        `${process.env.REACT_APP_API_BASE_URL}/users/list-privileges`,
        {
          user_id: itemId,
        },
        { headers }
  ...
  return (
    <>
      <div>
        <SimpleHeader name="Akses Pengguna" parentName="Master" />
        <Container className="mt--6" fluid>
          <Row>
            <div className="col">
              ...
              {/* <CardBody> */}
              {/* Button card */}
              <Card className="position-sticky" style={{ top: 0, zIndex: "5" }}>
                  ...
                  {allItem?.response ? (
                    allItem.response.map((item) => (
                      ...
                      >
                        ...
                        <div>
                          <b>username:</b>{" "}
                          {item.username ? item.username : "(Not available)"}
                        </div>
                        <div>
                          <b>Kode User:</b>{" "}
                          {item.user_code ? item.user_code : "(Not available)"}
                        </div>
              ...
              <Card className="position-sticky" style={{ top: 0, zIndex: "1" }}>
                                  ...
                                  <Button
                                    ...
                                    onClick={() =>
                                      changeItemDataTable({
                                        index: key,
                                        privilegename:
                                          savedItem.data.privilege_name,
                                        create_access:
                                          savedItem.data.create_access,
                                        read_access: savedItem.data.read_access,
                                        update_access:
                                          savedItem.data.update_access,
                                        delete_access:
                                          savedItem.data.delete_access,
                                      })
                                    }
                                  >
                                    Update
