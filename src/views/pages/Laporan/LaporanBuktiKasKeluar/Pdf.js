    ...
    <Document>
        ...
        <Table data={allPenawaranSo} style={s.my1}>
                <TableHeader textAlign={"center"}>
                    ...
                    <TableCell style={s.fs08}>Kode BKK</TableCell>
                    <TableCell style={s.fs08}>Kode Invoice</TableCell>
                    <TableCell style={s.fs08}>Supplier</TableCell>
                ...
                <TableBody  textAlign={"center"} >
                    ...
                    <DataTableCell getContent={(r) => r.bkk_code}  style={s.fs08}/>
                    <DataTableCell getContent={(r) => r.code_invoice}  style={s.fs08}/>
                    <DataTableCell getContent={(r) => r.supplier_name}  style={s.fs08}/>
