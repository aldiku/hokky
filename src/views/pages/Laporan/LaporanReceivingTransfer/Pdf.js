...
const PdfReportReceivingTransfer = ({data}) => {
    ...
    <Document>
        ...
        <Text style={[s.textCenter,s.fs18,s.borderBottom, s.my1]}>Laporan Receiving Transfer</Text>
...
export default PdfReportReceivingTransfer;