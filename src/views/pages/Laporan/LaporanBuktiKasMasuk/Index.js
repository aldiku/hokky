...
const LaporanBuktiKasMasuk = () => {
  ...
  const downloadExcel = async ()=> {
    ...
    axios
      .post(`${process.env.REACT_APP_API_BASE_URL}/bkm/page`, filter, {
        headers,
      })
      .then((res) => {
  ...
  return (
    <div>
        <SimpleHeader name="Laporan Bukti Kas Masuk" parentName="Report" />
                                ...
                                <br></br>
                                  ...
                                  <UncontrolledDropdown nav>
                                      ...
                                      <PDFDownloadLink
                                          ...
                                          fileName="Report Bukti Kas Masuk.pdf"
                                          style={{color: '#000'}}>
                                            PDF
                                      </PDFDownloadLink>
                                    </DropdownItem>
...
export default LaporanBuktiKasMasuk;