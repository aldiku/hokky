...
const PdfReportBKM = ({data}) => {
    ...
    <Document>
        ...
        <Text style={[s.textCenter,s.fs18,s.borderBottom, s.my1]}>Laporan Bukti Kas Masuk</Text>
        ...
        <Table data={allPenawaranSo} style={s.my1}>
                <TableHeader textAlign={"center"}>
                    ...
                    <TableCell style={s.fs08}>Kode BKM</TableCell>
                    <TableCell style={s.fs08}>Kode Invoice</TableCell>
                    <TableCell style={s.fs08}>Customer</TableCell>
                    <TableCell weighting={0.3} style={s.fs08}>Pembayaran</TableCell>
                    {/* <TableCell style={s.fs08}>Keterangan</TableCell> */}
                </TableHeader>
                <TableBody  textAlign={"center"} >
                    <DataTableCell getContent={(r) => r.created_at}  style={s.fs08}/>
                    <DataTableCell getContent={(r) => r.bkm_code}  style={s.fs08}/>
                    <DataTableCell getContent={(r) => r.code_invoice}  style={s.fs08}/>
                    <DataTableCell getContent={(r) => r.customer_name}  style={s.fs08}/>
                    <DataTableCell weighting={0.3} getContent={(r) => r.pembayaran_total} style={[s.fs08,s.textCenter]}/>
