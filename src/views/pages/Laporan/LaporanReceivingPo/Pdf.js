...
const PdfReportReceivingPo = ({data}) => {
    ...
    <Document>
        ...
        <Text style={[s.textCenter,s.fs18,s.borderBottom, s.my1]}>Laporan Receiving PO</Text>
        ...
        <Table data={allPenawaranSo} style={s.my1}>
                <TableHeader textAlign={"center"}>
                    ...
                    <TableCell style={s.fs08}>Kode PO</TableCell>
                ...
                <TableBody  textAlign={"center"} >
                    ...
                    <DataTableCell getContent={(r) => r.code_po}  style={s.fs08}/>
                    <DataTableCell getContent={(r) => r.person_name}  style={s.fs08}/>
...
export default PdfReportReceivingPo;