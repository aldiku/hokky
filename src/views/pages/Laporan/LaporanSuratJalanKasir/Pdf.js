...
const PdfReportSuratJalanKasir = ({data}) => {
    ...
    <Document>
        ...
        <Text style={[s.textCenter,s.fs18,s.borderBottom, s.my1]}>Laporan Surat Jalan Kasir</Text>
...
export default PdfReportSuratJalanKasir;