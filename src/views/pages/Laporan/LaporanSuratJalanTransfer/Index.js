...
const LaporanSuratJalanTransfer = () => {
  ...
  const downloadExcel = async ()=> {
    var fileName = 'Laporan-surat-jalan-proyek'
    ...
    axios
      .post(`${process.env.REACT_APP_API_BASE_URL}/transfer-surat-jalan/page`, filter, {
        headers,
      })
      .then((res) => {
  ...
  return (
    <div>
        <SimpleHeader name="Laporan Surat Jalan Transfer" parentName="Report" />
        <Container className="mt--6" fluid>
            ...
            <Card className="bg-secondary shadow">
                <CardHeader className="bg-white border-0">
                    ...
                    <h3>Laporan Surat Jalan Transfer</h3>
                                ...
                                <br></br>
                                  ...
                                  <UncontrolledDropdown nav>
                                      ...
                                      <PDFDownloadLink
                                          ...
                                          fileName="Report Surat Jalan Transfer.pdf"
                                          style={{color: '#000'}}>
                                            PDF
                                      </PDFDownloadLink>
                                    </DropdownItem>
...
export default LaporanSuratJalanTransfer;