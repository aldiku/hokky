...
const LaporanInvoiceSoKasir = () => {
  ...
  const downloadExcel = async ()=> {
    var fileName = 'Laporan-Invoice-SO-Proyek'
    ...
    axios
      .post(`${process.env.REACT_APP_API_BASE_URL}/invoice-so/page`, filter, {
        headers,
      })
      .then((res) => {
  ...
  return (
    <div>
        <SimpleHeader name="Laporan Invoice SO Kasir" parentName="Report" />
        <Container className="mt--6" fluid>
            ...
            <Card className="bg-secondary shadow">
                <CardHeader className="bg-white border-0">
                    ...
                    <h3>Laporan Invoice SO Kasir</h3>
                                ...
                                <br></br>
                                  ...
                                  <UncontrolledDropdown nav>
                                      ...
                                      <PDFDownloadLink
                                          ...
                                          fileName="Report Invoice Kasir.pdf"
                                          style={{color: '#000'}}>
                                            PDF
                                      </PDFDownloadLink>
                                    </DropdownItem>
...
export default LaporanInvoiceSoKasir;