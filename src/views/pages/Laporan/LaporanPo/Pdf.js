...
const PdfReportPo = ({data}) => {
    ...
    <Document>
        ...
        <Text style={[s.textCenter,s.fs18,s.borderBottom, s.my1]}>Laporan Purchase Order</Text>
        ...
        <Table data={allPenawaranSo} style={s.my1}>
                ...
                <TableBody  textAlign={"center"} >
                    ...
                    <DataTableCell getContent={(r) => r.po_code}  style={s.fs08}/>
