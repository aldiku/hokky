...
const LaporanInvoiceSo = () => {
  ...
  return (
    <div>
        <SimpleHeader name="Laporan Invoice SO Proyek" parentName="Report" />
        <Container className="mt--6" fluid>
            ...
            <Card className="bg-secondary shadow">
                <CardHeader className="bg-white border-0">
                    ...
                    <h3>Laporan Invoice SO Proyek</h3>
                                ...
                                <br></br>
                                  ...
                                  <UncontrolledDropdown nav>
                                      ...
                                      <PDFDownloadLink
                                          ...
                                          fileName="Report Invoice So Proyek.pdf"
                                          style={{color: '#000'}}>
                                            PDF
                                      </PDFDownloadLink>
                                    </DropdownItem>
...
export default LaporanInvoiceSo;