...
const LaporanSuratJalanProyek = () => {
  ...
  return (
    <div>
        <SimpleHeader name="Laporan Surat Jalan Proyek" parentName="Report" />
        <Container className="mt--6" fluid>
            ...
            <Card className="bg-secondary shadow">
                <CardHeader className="bg-white border-0">
                    ...
                    <h3>Laporan Surat Jalan Proyek</h3>
                                ...
                                <br></br>
                                  ...
                                  <UncontrolledDropdown nav>
                                      ...
                                      <PDFDownloadLink
                                          ...
                                          fileName="Report Surat Jalan Proyek.pdf"
                                          style={{color: '#000'}}>
                                            PDF
                                      </PDFDownloadLink>
                                    </DropdownItem>
...
export default LaporanSuratJalanProyek;